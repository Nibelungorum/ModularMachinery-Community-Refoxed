...
public final class DefaultMachineLevels {
    ...
    public static void register() {
        MachineLevelRegistry.registerType(new LevelType(THERMAL_SMELTING_COIL_TYPE, Component.literal("热能冶炼线圈")));
        register(COPPER_COIL, 0, Blocks.COPPER_BLOCK, 0.9D);
        register(IRON_COIL, 1, Blocks.IRON_BLOCK, 0.8D);
        register(GOLD_COIL, 2, Blocks.GOLD_BLOCK, 0.7D);
        register(DIAMOND_COIL, 3, Blocks.DIAMOND_BLOCK, 0.6D);
    }
