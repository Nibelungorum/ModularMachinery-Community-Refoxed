...
public final class MachineRecipeBuilder {
    ...
    private final List<SmartInterfaceRequirement> smartInterfaceRequirements = new ArrayList<>();
    ...
    public MachineRecipeBuilder smartInterface(SmartInterfaceRequirement requirement) {
        ...
        smartInterfaceRequirements.add(requirement);
        return this;
    }
    ...
    public MachineRecipeDefinition build() {
        List<RecipeRequirement> recipeRequirements = new ArrayList<>(
                requirements.isEmpty() ? derivedRequirements() : requirements);
        recipeRequirements.addAll(smartInterfaceRequirements);
