...
public final class MachineRecipe implements Recipe<RecipeInput> {
    ...
    public MachineRecipe(Identifier id,
        ...
        this(id, machineId, tickTime, inputs, outputs, modifiers, priority, maxThreads, cancelRecipeOnPerTickFailure,
                fluidOutputs, requirements, parallelized, Collections.emptyList(), Set.of());
    }
    ...
    public MachineRecipe(Identifier id,
        ...
        this(id, machineId, tickTime, inputs, outputs, modifiers, priority, maxThreads, cancelRecipeOnPerTickFailure,
                fluidOutputs, requirements, parallelized, levelRequirements, Set.of());
    }
    ...
    private static MachineRecipe create(Identifier id,
                                        ...
                                        int tickTime,
                                         ...
                                         List<LevelRequirement> levelRequirements,
                                         Set<Identifier> requiredHostIds) {
        return new MachineRecipe(id, machineId, tickTime, inputs, outputs, modifiers, priority, maxThreads, cancelRecipeOnPerTickFailure, fluidOutputs, requirements, parallelized, levelRequirements, requiredHostIds);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, machineId, tickTime, requirements, modifiers, priority, maxThreads, cancelRecipeOnPerTickFailure, parallelized, levelRequirements, requiredHostIds);
    }
}
