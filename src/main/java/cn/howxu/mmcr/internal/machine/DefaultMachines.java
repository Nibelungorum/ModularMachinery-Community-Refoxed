...
public final class DefaultMachines {
     ...
     */
    public static Machine blastFurnace(Block casing, Block controller, Block itemPort, Block fluidPort) {
