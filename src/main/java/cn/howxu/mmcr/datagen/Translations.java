...
public final class Translations {
    ...
    public static final Map<String, Map<String, String>> ALL = Map.ofEntries(
            Map.entry("en_us", Map.ofEntries(
                    ...
                    Map.entry("item.mmcr.controller",              "Machine Controller"),
                    Map.entry("item.mmcr.casing",                  "Machine Casing"),
            ...
            Map.entry("zh_cn", Map.ofEntries(
                    ...
                    Map.entry("item.mmcr.controller",              "机器控制器"),
                    Map.entry("item.mmcr.casing",                  "机器外壳"),
